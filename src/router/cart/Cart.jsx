                    ...
                    <li key={item.id} className='flex items-center'>
                      <div className='flex items-center gap-[50px]'>
                        ...
                        <div className='ml-[50px] flex items-center gap-[10px] '>
                          <div className=' ml-[10px] flex items-center bg-[rgb(245,245,245)] w-[100px] justify-center gap-2 py-[5px] rounded-[20px]'>
                            <button onClick={decrement} disabled={count <= 0}><FaMinus /></button>
                            <h1>{count}</h1>
